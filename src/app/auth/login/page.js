            ...
            <div className="user-login">
              ...
              <div className="login-form border-[#b2937e] border bg-white">
                ...
                <div className="mt-10 mx-5">
                  <Link
                    href="/auth/register"
                    className="w-full font-roboto py-[9px] px-3 text-sm mt-4 mb-3 border hover:border-[#3c2f27] bg-[#3c2f27] border-[#3c2f27] hover:bg-transparent hover:text-[#3c2f27] text-[#faf2ec] block text-center"
                  >

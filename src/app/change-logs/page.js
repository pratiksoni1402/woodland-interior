    ...
    <div className="change-logs-page bg-primary-foreground border-t border-[#b2937e]">
      <div className="container">
        <div className="content-wrapper pb-10">
          ...
          <section>
            <h3 className=" font-crimson text-2xl text-primary">UI issue in product delete dialog and logic issue in user status (V1.1.3) (16/04/2024)</h3>
            <ul className="list-inside list-disc pl-5 text-primary font-roboto pt-2 pb-5">
              <li>Background became transparent due to change in global.css. </li>
              <li>Previously if user is logged-in or logged-out then the same icon was appearing now if user is logged-in then first character of his/her firstname and lastname will appear. </li>
            </ul>
          </section>

          <section>
            <h3 className=" font-crimson text-2xl text-primary">UI mismatch in some areas (V1.1.4) (25/04/2024)</h3>
            <ul className="list-inside list-disc pl-5 text-primary font-roboto pt-2 pb-5">
              <li>There were some UI mismatch issues like like color are different font is small in some areas big in some areas.</li>

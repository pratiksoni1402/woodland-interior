      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="shipping-detail-form">
          <div className="field-wrapper">
            ...
            {errors.shipping_first_name && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>

          <div className="field-wrapper">
            <input type="text" placeholder="Last name" {...register("shipping_last_name", { required: true, maxLength: 100 })} />
            {errors.shipping_last_name && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>

          <div className="field-wrapper">
            <input type="text" placeholder="Address Line 1" {...register("shipping_address_one", { required: true })} />
            {errors.shipping_address_one && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>

          <div className="field-wrapper">
            <input type="text" placeholder="Address Line 2" {...register("shipping_address_two", { required: true })} />
            {errors.shipping_address_two && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>
          ...
          <div className='grid grid-cols-3 sm:gap-5 gap-0'>
            <div className="sm:col-span-1 col-span-3">
              <div className="field-wrapper">
                ...
                {errors.shipping_country && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
              </div>
            </div>
            ...
            <div className="sm:col-span-1 col-span-3">
              <div className="field-wrapper">
                ...
                {errors.shipping_state && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
              </div>
            </div>
            ...
            <div className="sm:col-span-1 col-span-3">
              <div className="field-wrapper">
                ...
                {errors.shipping_city && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
              </div>
            </div>
          </div>
          ...
          <div className="field-wrapper">
            ...
            {errors.shipping_pincode && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>

          <div className="field-wrapper">
            <input type="text" placeholder="Landmark" {...register("shipping_landmark", { required: true })} />
            {errors.shipping_landmark && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>

          <div className="field-wrapper">
            <input type="text" placeholder="Phonenumber" {...register("shipping_phone_number", { required: true })} />
            {errors.shipping_phone_number && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
          </div>
            ...
            {showForm && (
              <div className="billing-detail-form">
                ...
                <div className="field-wrapper">
                  ...
                  {errors.billing_first_name && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>

                <div className="field-wrapper">
                  <input type="text" placeholder="Last name" {...register("billing_last_name", { required: true, maxLength: 100 })} />
                  {errors.billing_last_name && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>

                <div className="field-wrapper">
                  <input type="text" placeholder="Address Line 1" {...register("billing_address_one", { required: true })} />
                  {errors.billing_address_one && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>

                <div className="field-wrapper">
                  <input type="text" placeholder="Address Line 2" {...register("billing_address_two", { required: true })} />
                  {errors.billing_address_two && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>
                ...
                <div className='grid grid-cols-3 sm:gap-5 gap-0'>
                  <div className="sm:col-span-1 col-span-3">
                    <div className="field-wrapper">
                      ...
                      {errors.billing_country && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                    </div>
                  ...
                  <div className='sm:col-span-1 col-span-3'>
                    <div className="field-wrapper">
                      ...
                      {errors.billing_state && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                    </div>
                  ...
                  <div className="sm:col-span-1 col-span-3">
                    <div className="field-wrapper">
                      ...
                      {errors.billing_city && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                    </div>
                ...
                <div className="field-wrapper">
                  ...
                  {errors.billing_pincode && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>

                <div className="field-wrapper">
                  <input type="text" placeholder="Nearest Landmark" {...register("billing_landmark", { required: true })} />
                  {errors.billing_landmark && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>

                <div className="field-wrapper">
                  <input type="text" placeholder="Contact Number" {...register("billing_phone_number", { required: true })} />
                  {errors.billing_phone_number && <span className='error-message font-roboto text-sm text-red-700'>This field is required</span>}
                </div>

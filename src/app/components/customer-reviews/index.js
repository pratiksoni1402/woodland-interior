		...
		<div className="customer-reviews">
			<Tabs defaultValue="reviews">
				<TabsList className="tab-button grid w-40 grid-cols-1">
					<TabsTrigger
						value="reviews"
						className=" bg-[#3c2f27] rounded-none text-base font-crimson font-semibold"
					>
						Reviews
					</TabsTrigger>
				</TabsList>
								...
								<div className="review py-3 ">
									<div className="grid grid-cols-12 gap-5">
										<div className="col-span-2">
											<div className="image">
												<Image
													src="/uploads/images/reviews/male-avatar.jpg"
													alt="Avatar"
													width={100}
													height={100}
												/>
										...
										<div className="col-span-10">
											...
											<div className="text text-sm text-[#3c2f27] font-roboto">
												I recently purchased a beautiful dining set from
												Woodland Interiors, and I couldnt be happier with my
												decision. The craftsmanship is exquisite, and it adds a
								...
								<div className="review py-3 ">
									<div className="grid grid-cols-12 gap-5">
										<div className="col-span-2">
											<div className="image">
												<Image
													src="/uploads/images/reviews/female-avatar.jpg"
													alt="Avatar"
													width={100}
													height={100}
												/>
										...
										<div className="col-span-10">
											...
											<div className="text text-sm text-[#3c2f27] font-roboto">
												Shopping at Woodland Interiors was a delightful
								...
								<div className="review py-3 ">
									<div className="grid grid-cols-12 gap-5">
										...
										<div className="col-span-10">
											...
											<div className="text text-sm text-[#3c2f27] font-roboto">
												As an interior designer, I am always on the lookout for
								...
								<div className="review py-3 ">
									<div className="grid grid-cols-12 gap-5">
										...
										<div className="col-span-10">
											...
											<div className="text text-sm text-[#3c2f27] font-roboto">
												I am amazed by the quality of the sofa I ordered from
								...
								<div className="review py-3 ">
									<div className="grid grid-cols-12 gap-5">
										...
										<div className="col-span-10">
											...
											<div className="text text-sm text-[#3c2f27] font-roboto">
												I amm extremely satisfied with my purchase from Woodland
												Interiors. The dresser I ordered is not only stylish but
												also incredibly functional. The customer service was
												excellent, and I wouldnt hesitate to shop here again.
											</div>
										</div>
									</div>
								</div>

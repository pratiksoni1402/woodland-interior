...
import Logo from '../../../../public/uploads/images/logos/new-logo.png';
const footer = () => {
	return (
					...
					<div className="upper-footer-wrapper grid lg:grid-cols-6 md:grid-cols-5 sm:grid-cols-4 grid-cols-2 gap-10 lg:justify-around md:justify-evenly">
						...
						<div className="col lg:order-2 md:order-1 sm:order-1 order-1">
							<div className=" text-[#3c2f27] text-sm font-roboto ">
								...
								<ul>
									<li>
										<Link href="/" className="make-bold-props" title="Home">
											Home
										</Link>
									</li>
									<li>
						...
						<div className="col lg:order-2 md:order-1 sm:order-1 order-1">
							<div className=" text-[#3c2f27] text-sm font-roboto">
								...
								<ul>
									<li>
										<Link href="#" className="make-bold-props" title="Blog">
											Blog
										</Link>
									</li>
									<li>
										<Link href="#" className="make-bold-props" title="Visit Us">
											Visit Us
										</Link>
									</li>
									<li>

                  ...
                  <div className='dropdown'>
                    <DropdownMenu className=''>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline" className='pb-1  text-sm font-roboto text-[#3c2f27] bg-transparent border-0 mt-[-13px] hover:bg-transparent group hover:underline font-normal transition duration-500'>
                          Shop
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent className="w-48 bg-[#faf2ec] rounded-none left-[-20px] top-[-10px] fixed">
                        <DropdownMenuGroup>
                          <DropdownMenuItem className=' hover:bg-transparent'>
                            <BedDouble className="mr-2 h-4 w-4" color='#3c2f27' />
                            <Link href='/shop/bedroom' className="group text-[#3c2f27] text-sm font-roboto hover:underline transition duration-500">
                              Bedroom
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem className=''>
                            <DoorClosed className="mr-2 h-4 w-4" color='#3c2f27' />
                            <Link href='/shop/dining-tables' className="group text-[#3c2f27] text-sm font-roboto hover:underline transition duration-500">
                              Dining Tables
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem>
                            <Sofa className="mr-2 h-4 w-4" color='#3c2f27' />
                            <Link href='/shop/sofa-sets' className="group text-[#3c2f27] text-sm font-roboto hover:underline transition duration-500">
                              Sofa Sets
                            </Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem>
                            <TentTree className="mr-2 h-4 w-4" color='#3c2f27' />
                            <Link href='/shop/outdoor' className="group text-[#3c2f27] text-sm font-roboto hover:underline transition duration-500">
                              Outdoor
                            </Link>
                          </DropdownMenuItem>
                        </DropdownMenuGroup>

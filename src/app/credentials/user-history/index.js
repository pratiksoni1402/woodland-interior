...
export default function History(){
    ...
    return(
        <div className="user-history flex justify-center">
                                    ...
                                    {isHovered && (
                                        <div className='buttons absolute z-10 text-center top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]'>
                                            {/* Add your buttons here */}
                                                ...
                                                <Button className='border border-[#3c2f27] py-2 px-[10px] text-[#3c2f27] my-[5px] bg-[#faf2ec] w-[200px] inline-block rounded-none'>View</Button>

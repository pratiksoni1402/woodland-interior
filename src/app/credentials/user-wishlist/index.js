        ...
        <div className='my-items lg:w-3/4 w-full mx-auto  '>
          <Toaster />
          {
            allproducts?.map((product) => (
              <div className='product pt-10 pb-5 border-b border-[#b2937e]' key={product.id}>
                <div className="grid grid-cols-12 gap-3">
                  <div className="xl:col-span-2 lg:col-span-3 sm:col-span-4 col-span-12">
                    <Image src={`${PRODUCT_MEDIA_URL}/${product.products.image}`} alt={product.products.name} height={150} width={150} className="sm:w-[150px] w-full" />
                  </div>

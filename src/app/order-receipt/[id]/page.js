...
export default function Orderreceipt({ params }) {
  ...
  const { isPending, data: receipt, isError } = useQuery({
  ...
  const billingLandmark = (receipt?.billing_landmark ?? receipt?.shipping_landmark);
  const billingPhoneNumber = (receipt?.billing_phone_number ?? receipt?.shipping_phone_number);
  return (
                    ...
                    <div className="grid grid-cols-2 gap-5">
                      <div className="sm:col-span-1 col-span-2">
                        <div className="shipping-address pb-5">
                          ...
                          <div className="address font-roboto text-sm text-[#3c2f27] pl-4">
                            ...
                            <span className="value font-semibold pl-1">{receipt?.shipping_address_one}</span>
                          </div>
                          <div className="state font-roboto text-sm text-[#3c2f27] pl-4">
                            <span className="caption">Country:</span>
                            <span className="value font-semibold pl-1">{receipt?.shipping_country}</span>
                          </div>
                          <div className="state font-roboto text-sm text-[#3c2f27] pl-4">
                            <span className="caption">State:</span>
                            <span className="value font-semibold pl-1">{receipt?.shipping_state}</span>
                          </div>
                          <div className="city font-roboto text-sm text-[#3c2f27] pl-4">
                            <span className="caption">City:</span>
                            <span className="value font-semibold pl-1">{receipt?.shipping_city}</span>
                          </div>
                          <div className="pincode font-roboto text-sm text-[#3c2f27] pl-4">
                            <span className="caption">Pincode:</span>
                            <span className="value font-semibold pl-1">{receipt?.shipping_pincode}</span>
                          </div>
                          <div className="contact-number font-roboto text-sm text-[#3c2f27] pl-4">
                            <span className="caption">Phone Number:</span>
                            <span className="value font-semibold pl-1">{receipt?.shipping_phone_number}</span>
                          </div>
                        </div>
                      </div>
                      <div className="sm:col-span-1 col-span-2">
                      ...
                      <div className="sm:col-span-1 col-span-2">
                        <div className="payment-method pb-5">
                          ...
                          <div className="name font-roboto text-sm text-[#3c2f27] pl-4">
                            <span className="value font-semibold pl-1">{receipt?.payment_mode}</span>
                          </div>
                        </div>
                      </div>
                      <div className="sm:col-span-1 col-span-2">

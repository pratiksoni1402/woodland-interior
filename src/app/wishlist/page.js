  ...
  return (
    <div className="product-wrapper bg-[#faf2ec] pb-20">
      <div className="container">
        ...
        <div className='my-items h-full border-t border-[#b2937e] '>
          <Toaster />
          {
            allproducts?.length === 0 ? (
              <div className="w-full h-screen flex-col font-crimson text-4xl text-[#3c2f27] flex items-center justify-center">
